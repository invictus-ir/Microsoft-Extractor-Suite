...
1. If I enable mailbox auditing now can I see historical records?
    - No, additionally if you enable auditing now it can take up to 24 hours before events will be logged.

2. Which date format does the script accept as input?
