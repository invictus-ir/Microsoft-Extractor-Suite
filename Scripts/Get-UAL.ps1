...
<#
	...
	.EXAMPLE
	Get-UALSpecific -ActivityType Add service principal. -UserIds "Test@invictus-ir.com,HR@invictus-ir.com"
	...
	.EXAMPLE
	Get-UALSpecific -ActivityType MailItemsAccessed -StartDate 1/4/2023 -EndDate 5/4/2023
	Gets the MailItemsAccessed logging from the unified audit log entries between 1/4/2023 and 5/4/2023.
	
	.EXAMPLE
	Get-UALSpecific -ActivityType MailItemsAccessed -UserIds Test@invictus-ir.com -StartDate 25/3/2023 -EndDate 5/4/2023 -Interval 720 -Output JSON
